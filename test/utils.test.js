import { collect, mergeValue, transformOutputValue, transformInputValue } from "../src/util/utils"
...
describe("transformOutputValue", () => {
  ...
  test("oldV 和 content 的 key 没有对应上的情况", () => {
    ...
    expect(transformOutputValue(input, content, { strict: true })).toEqual(outputStrict)
